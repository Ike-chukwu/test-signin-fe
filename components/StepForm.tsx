...
import { RingingIcon, TextMessageIcon } from "./icons";
...
const StepForm = () => {
  ...
  return (
    <div className="mt-[-30px] w-[350px] md:w-[450px] drop-shadow-custon bg-white rounded-[10px] py-8 px-8 top-[90px] flex-col flex gap-5 items-center  ">
      <h2 className="text-[#242C39] flex items-center justify-center w-full font-bold pb-4 text-[15px] ">
      ...
      {/* <>
        ...
        <div className="border-[2.7px] rounded-[4px] w-full border-[#5E7EB4] px-2 py-1 flex items-center gap-4">
